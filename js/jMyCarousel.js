...
$.fn.jMyCarousel = function(o) {   
    o = $.extend({
        ...
        speed: 1800,				// speed in ms of the animation.
        ...
        visible: '100px',			// size of the carousel on the screen. Can be in percent '100%', in pixels '100px', or in images '3' (for 3 images)
